...
cdef class _LinkedList:
    ...
    cdef void remove_node(self, _Node node) noexcept:
    ...
    cdef void append_node(self, _Node node) noexcept:
...
cpdef Py_ssize_t get_plan_cache_size() noexcept:
...
# TODO(leofang): remove experimental warning when scipy/scipy#12512 is merged
cpdef Py_ssize_t get_plan_cache_max_memsize() noexcept:
