...
ctypedef nvrtcResult (*F_nvrtcGetLTOIRSize)(nvrtcProgram prog, size_t *ltoirSizeRet) noexcept nogil  # NOQA
cdef F_nvrtcGetLTOIRSize nvrtcGetLTOIRSize

ctypedef nvrtcResult (*F_nvrtcGetLTOIR)(nvrtcProgram prog, char *ltoir) noexcept nogil
